...
const slides = [
  {
    ...
    description: "Receive payments instantly for every order delivered - Fast Payouts like never Before.",
    image: "/images/phone-4.png"
  },
  {
    id: 2,
    title: "Expand Your Reach",
    description: "Connect with thousands of local customers and grow your business footprint effortlessly.",
    image: "/images/phone-7.png"
  },
  {
    id: 3,
    title: "Simple Management",
    description: "Track orders and earnings in real-time with our intuitive partner dashboard. Manage everything in one place.",
